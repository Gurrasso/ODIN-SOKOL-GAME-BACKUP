...
import fcore "../lib/fmod/core"
import fstudio "../lib/fmod/studio"
...
init :: proc(volume: f32) {
	...
	fmod_error_check(System_LoadBankFile(system, "src/assets/fmod/game-odin/Build/Desktop/Master.bank", LOAD_BANK_NORMAL, &bank))
	fmod_error_check(System_LoadBankFile(system, "src/assets/fmod/game-odin/Build/Desktop/Master.strings.bank", LOAD_BANK_NORMAL, &strings_bank))
...
update_master_volume :: proc(master_volume: f32){
